...
#
# TRIMMED for EditCTC: only the dataset classes actually named in the 5
# configs (SimpleDataSet for Eval, MultiScaleDataSet for Train) and the
# sampler used by Train (MultiScaleSampler) are registered here.
# LMDBDataSet, PGDataSet, PubTabDataSet, LaTeXOCRDataSet and their source
# files were dropped -- none of them are reachable from these configs.
